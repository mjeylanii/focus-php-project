    ...
    <div class="container my-5 ">
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="images">
                    <img src="images/sean.jpg" style="width: 480px; height: 400    px">
                </div>
            </div>
            <div id="promotion-text" class="col-md-6 mb-3 bg-light">
...
<div class="container-fluid text-center">
    <h1 class="display-4 fw-normal">Our <span class="text-success fw-bold">Services</span></h1>
        ...
        <div class="col mb-3">
            <div class="card border-success border-4 h-100 p-5 rounded bg-light">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit
                        amet orci.</p>
                </div>
            </div>
        </div>
