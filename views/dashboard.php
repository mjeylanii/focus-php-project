...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ">
    <h2>Dashboard</h2>
    <h5 class="text-center">Daily Page Hits</h5>
    <div class="my-5" id="bar-chart"></div>
    <h5 class="text-center">Traffic Over Time</h5>
    <div class="my-5"  id="line-chart"></div>
    <h5 class="text-center">Page Hits per Country</h5>
    <div class="my-5 mx-auto" id="pie-chart"></div>
